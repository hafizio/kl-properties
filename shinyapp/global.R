...
propData <- g_oriPropData
  ...
  propData$LocationGroup[propData$LocationGroup == "Bukit Ledang, Kuala Lumpur"] <-"BUKIT WELD"
  propData$LocationGroup[propData$LocationGroup == "Bukit Tunku (Kenny Hills), Kuala Lumpur"] <-"BUKIT WELD"
  ...
  propData$LocationGroup[propData$LocationGroup == "Jalan Sultan Ismail, Kuala Lumpur"] <-"JALAN AMPANG"
  ...
  propData$LocationGroup[propData$LocationGroup == "U-THANT, Kuala Lumpur"] <-"BUKIT WELD"
